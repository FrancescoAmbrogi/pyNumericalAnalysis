"""
In some branch of physics the data we acquire 
are somewhat noisy. Derivatives tends to amplify the noise 
and we need to be able to go through this problem. Here is
an example of noisey data and hw the 2 point forfula works
compared with a 4 stencil finite difference formula
"""
import numpy as np
